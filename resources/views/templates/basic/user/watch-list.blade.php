                    ...
                    <div class="custom--card card">
                        <div class="card-header">
                            <div class="btn-group col-12">
                                <a href="{{route('user.watchList')}}" class="btn btn-primary">Watch List</a>
                                <a href="{{route('user.watchListOrder')}}" class="btn btn-light text-danger mx-3">Order Book</a>
                                <a href="{{route('user.watchListPosition')}}" class="btn btn-light text-danger">Trade Position</a>
                            </div>
                        </div>
