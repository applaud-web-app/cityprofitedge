        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.investment.thematic-portfolios')}}">
                    <a href="{{route('admin.investment.thematic-portfolios.all')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Thematic Portfolios')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.investment.global-stock-portfolios')}}">
                    <a href="{{route('admin.investment.global-stock-portfolios.all')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Global Stock Portfolio')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.investment.fo-portfolio-hedging')}}">
                    <a href="{{route('admin.investment.fo-portfolio-hedging.all')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('F&O Portfolio-Hedging')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.investment.metals-portfolios')}}">
                    <a href="{{route('admin.investment.metals-portfolios.all')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Metals Portfolio')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.portfolio-insights.top-gainers')}}">
                    <a href="{{route('admin.portfolio-insights.top-gainers.all')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Portfolio Top Gainers')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.portfolio-insights.top-losers')}}">
                    <a href="{{route('admin.portfolio-insights.top-losers.all')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Portfolio Top Losers')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.financial-overview.ledger')}}">
                    <a href="{{route('admin.financial-overview.ledger.all')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Ledgers')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.financial-overview.stock-portfolio')}}">
                    <a href="{{route('admin.financial-overview.stock-portfolio.all')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Stock Portfolio')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.transaction')}}">
                    <a href="{{route('admin.transaction.all')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
